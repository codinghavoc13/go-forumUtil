...
DROP TABLE IF EXISTS react_forum.posts;
...
DROP TABLE IF EXISTS react_forum.responses;
...
DROP TABLE IF EXISTS react_forum.rooms;
...
DROP TABLE IF EXISTS react_forum.users;
...
INSERT INTO react_forum.responses(
...
var INSERT_USERS = `
INSERT INTO react_forum.users(first_name, last_name)
	VALUES ('Anne', 'Obrien'),
    ('Ira', 'Sprague'),
    ('Beverly', 'Wheeler'),
    ('Marianne', 'Shultz'),
